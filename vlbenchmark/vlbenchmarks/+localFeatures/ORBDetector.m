classdef  ORBDetector < helpers.GenericInstaller ...
  ...
  methods
    ...
    function [frames descriptors] = extractFeatures(obj, imagePath)
      ...
      [f, d] = ORB(img,...
        ...
        'NLevels',obj.Opts.n_levels, ...
        'EdgeThreshold', obj.Opts.edge_threshold,...
        'FirstLevel', obj.Opts.first_level,...
