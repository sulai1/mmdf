...
\tikzoverlay[text width=0.98\paperwidth] at (-1cm,2cm) {
  \begin{tabular}{cc}
	\includegraphics[width=0.45\paperwidth]{img/sift_map.png}&
	\includegraphics[width=0.45\paperwidth]{img/surf_map.png}
  \end{tabular}
};
\end{frame}
...
\tikzoverlay[text width=0.98\paperwidth] at (-1cm,2cm) {
  \begin{tabular}{cc}
	\includegraphics[width=0.45\paperwidth]{img/orb_map.png}&
	\includegraphics[width=0.45\paperwidth]{img/phow_map.png}
  \end{tabular}
};
\end{frame}
